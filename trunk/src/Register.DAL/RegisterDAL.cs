        ...
        public ResultInfo SetEnrollInfo(RegisterModel model)
        {
            ...
            try
            {
                using (var db = new RegisterDB())
                {
                    ...
                    prms.Add(new CommonParameter("@SCHOOL_COUNTRY", model.SchoolProvinceName));
